...
module.exports = {
	...
	// Translation options.
	textDomain: 'pho2u', // Your textdomain here.
	translationFile: 'pho2u.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Pho2u!', // Package name.
	bugReport: 'https://fdsoftware.co.uk/', // Where can users report bugs.
	lastTranslator: 'FD Software <sales@fdsoftware.co.uk>', // Last translator Email ID.
	team: 'FD Software <sales@fdsoftware.co.uk>', // Team's Email ID.

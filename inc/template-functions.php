 ...
 */
 class pho2u_walker extends Walker_Nav_Menu {
	...
	function start_lvl( &$output, $depth = 0, $args = array() ) {
		$output .= '<i class="dropdown icon"></i><div class="menu" alt="' . $depth .'">';
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		{
			$class_names .= "ui dropdown" .$class_names;
		} 
		$id = apply_filters( 'nav_menu_item_id', 'menu-item-'. $item->ID, $item, $args );
		$id = $id ? ' id="' . esc_attr( $id ) . '"' : '';
		$output .= '<div class="' . $class_names . ' item">';
 ...
 class pho2u_mobile_walker extends Walker_Nav_Menu {

	function start_lvl( &$output, $depth = 0, $args = array() ) {
		$output .= '<i class="dropdown icon"></i><div class="ui right dropdown item">';
